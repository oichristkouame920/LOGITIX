...
<body class="reservation-page">
                        ...
                        <div class="booking-form-wrap">
                            <div class="row">
                                <div class="col-lg-12 col-12 p-0">
                                    <!-- FORMULAIRE : action vers client/traitement_inscription.php -->
                                    <form class="custom-form booking-form" action="client/traitement_inscription.php" method="post" role="form" id="formInscription" novalidate>
                                        <?= csrfField() ?>
                                        ...
                                        <div class="booking-form-body">
                                            ...
                                            <!-- Messages flash (succès ou autres) -->
                                            <?php displayFlash(); ?>
                                            ...
                                            <div class="row justify-content-center g-3">
                                                <div class="col-lg-5 col-12">
                                                    <div class="field-icon">
                                                        ...
                                                        <input type="text" name="nom" id="booking-form-name" class="form-control" placeholder="Nom" required value="<?= e($old['nom'] ?? '') ?>">
                                                    </div>
                                                </div>
                                                <div class="col-lg-5 col-12">
                                                    <div class="field-icon">
                                                        <i class="bi bi-person"></i>
                                                        <input type="text" name="prenom" id="cree-form-prenom" class="form-control" placeholder="Prénoms" required value="<?= e($old['prenom'] ?? '') ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row justify-content-center g-3 mt-1">
                                                <div class="col-lg-5 col-12">
                                                    <div class="field-icon">
                                                        ...
                                                        <input type="email" name="email" id="cree-form-mail" class="form-control" placeholder="Email" required value="<?= e($old['email'] ?? '') ?>">
                                                    </div>
                                                </div>
                                                <div class="col-lg-5 col-12">
                                                    <div class="field-icon">
                                                        <i class="bi bi-telephone"></i>
                                                        <input type="tel" class="form-control" name="telephone" id="cree-form-phone" placeholder="Numéro de téléphone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required value="<?= e($old['telephone'] ?? '') ?>">
                                                    </div>
                                            ...
                                            <div class="row justify-content-center g-3 mt-1">
                                                <div class="col-lg-5 col-12">
                                                    <div class="field-icon">
                                                        ...
                                                        <select class="form-control" name="status" id="cree-form-status" required>
                                                            ...
                                                            <option value="entreprise" <?= (($old['status'] ?? '') === 'entreprise') ? 'selected' : '' ?>>Entreprise</option>
                                                            <option value="cooperative" <?= (($old['status'] ?? '') === 'cooperative') ? 'selected' : '' ?>>Coopérative / Association</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-lg-10 col-12">
                                                    <div id="bloc-entreprise" class="<?= (($old['status'] ?? '') === 'entreprise' || ($old['status'] ?? '') === 'cooperative') ? 'actif' : '' ?>">
                                                        <p class="form-section-title" style="margin-top:0;color:#fff;">Informations professionnelles</p>
                                                        <div class="row g-3">
                                                            <div class="col-lg-6 col-12">
                                                                <div class="field-icon">
                                                                    <i class="bi bi-building"></i>
                                                                    <input type="text" name="raison_sociale" id="cree-form-raison-sociale" class="form-control" placeholder="Nom de l'entreprise / structure" value="<?= e($old['raison_sociale'] ?? '') ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-12">
                                                                <div class="field-icon">
                                                                    <i class="bi bi-file-earmark-text"></i>
                                                                    <input type="text" name="rccm" id="cree-form-rccm" class="form-control" placeholder="N° RCCM / Immatriculation" value="<?= e($old['rccm'] ?? '') ?>">
                                                                </div>
                                            ...
                                            <div class="row justify-content-center g-3">
                                                <div class="col-lg-5 col-12">
                                                    <div class="password-wrap">
                                                        <input type="password" class="form-control" name="mot_de_passe" id="cree-form-passwd" placeholder="Mot de Passe" required>
                                                ...
                                                <div class="col-lg-5 col-12">
                                                    <div class="password-wrap">
                                                        <input type="password" class="form-control" name="confirmation" id="cree-form-confpasswd" placeholder="Confirmer le mot de passe" required>
                                            ...
                                            <div class="row mt-3">
                                                <div class="politique" class="col-12 col-lg-10">
                                                    <h5>Politique de confidentialité</h5>

                                                    <label class="politique-consent-option" for="accepte">
                                                        <input type="radio" name="confid" id="accepte" value="accepte" <?= (($old['confid'] ?? '') === 'accepte') ? 'checked' : '' ?>>
                                                        J'accepte la politique de confidentialité
                                                    </label>
                                                    <label class="politique-consent-option" for="refuse">
                                                        <input type="radio" name="confid" id="refuse" value="refuse" <?= (($old['confid'] ?? '') === 'refuse') ? 'checked' : '' ?>>
                                                        Je refuse
                                                    </label>
                                            ...
                                            <div class="text-center mt-3">
                                                <a href="se_connecter.php" class="retour-connexion">
                                                    <i class="bi bi-arrow-left"></i> Déjà inscrit ? Connectez-vous
                                                </a>
                                            </div>
    ...
    <script>
        /* Script pour griser le bouton tant que l'utilisateur n'a pas coché "J'accepte" */
    ...
    <script>
        /* Affiche les champs entreprise si "Entreprise" ou "Coopérative" est sélectionné */
