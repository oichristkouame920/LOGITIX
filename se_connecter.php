    ...
    <body class="reservation-page">
            ...
            <main>
                <nav class="navbar navbar-expand-xl">                
                    <div class="container">
                        <div class="navbar-brand d-flex align-items-center">
                            <a href="index.html"><img src="images/logo.png" class="navbar-brand-image img-fluid" alt="LOGITIX"></a>
                        </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav ms-lg-auto">
                                <li class="nav-item">
                                    <a class="nav-link click-scroll" href="index.html">Acceuil</a>
                                </li>
        
                                <li class="nav-item">
                                    <a class="nav-link click-scroll" href="index.html#section_2">A propos de nous</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link click-scroll" href="index.html#section_3">Notre flotte</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link click-scroll" href="index.html#section_4">Nos Services </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link click-scroll" href="index.html#section_6">Nos Entrepôts</a>
                                </li>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-12 mx-auto ms-lg-auto">
                            <div class="booking-form-wrap">
                                <div class="row">
                                            ...
                                            <div class="booking-form-body">
                                                <div class="row">
                                                    <div class="col-lg-6 col-12">
                                                        <input type="text" name="conne-form-login" id="conne-form-login" class="form-control" placeholder="Login" required>
                                                    </div>

                                                    <div class="col-lg-6 col-12">
                                                        <input type="password" class="form-control" name="conne-form-passwd" placeholder="Mot de passe" required>
                                                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-12 me-auto">
                               ...
                               <strong class="text-white">
                                ...
                                <ul class="social-icon mt-4">
                                    ...
                                    <li class="social-icon-item"><a href="https://wa.me/2250503231625?text=Bonjour j'aimerais avoir plus d'information sur les chambres" class="social-icon-link bi-whatsapp"></a></li>
                                </ul>
                            </div>
                            ...
                            <!-- <div class="col-lg-5 col-12">
                                <em class="text-white d-block mb-4">Nos Horaires</em>
